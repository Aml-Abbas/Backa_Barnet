...
export class EditConversationMaterialComponent implements OnInit, ComponentCanDeactivate {
  ...
  //child scores and comment
  grades: string[] = [];
  comments: string[] = [];

  //guardian 1 scores and comment
  grades1: string[] = [];
  comments1: string[] = [];

  //guardian 2 scores and comment
  grades2: string[] = [];
  comments2: string[] = [];
  ...
  ngOnInit(): void {
    ...
    // save the information on the choosen child in a person typ variable to be able to get the information later
    ...
    this.current_conversation_card$.subscribe(data => {
      ...
      // check if it is only one parent or the both who wrote the card
      ...
      // save the scores and comments from the choosen card in these varabels
  ...
  // save the changes on the choosen card 
